...
export function DashboardSidebar({
          ...
          {menuItems.map((section) => (
            <div key={section.section}>
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isCollapsed
                    ? 'justify-center'
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:flex flex-col bg-white border-r border-border transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'
          }`}
      >
        <SidebarContent />
      </aside>
